...
public class ProductController {
    ...
    @PostMapping("saveproductsingle")
    public ProductData  single(@RequestBody  ProductData productData){
        productServices.singleSave(productData);
        return productData;
    }
    ...
    private void removeProduct(@RequestParam String productid){
